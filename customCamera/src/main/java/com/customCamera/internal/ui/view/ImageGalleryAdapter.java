package com.customCamera.internal.ui.view;
...
import com.customCamera.internal.glide.GlideApp;
...
public class ImageGalleryAdapter extends RecyclerView.Adapter<ImageGalleryAdapter.GalleryViewHolder> {
    ...
    public void onBindViewHolder(final GalleryViewHolder holder, final int position) {
        ...
        if (uri != null) {
            int type = BaseCameraActivity.getMimeType(context, uri.toString());
            if (type == CustomCamera.MediaType.PHOTO) {
