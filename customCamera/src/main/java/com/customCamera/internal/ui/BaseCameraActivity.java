package com.customCamera.internal.ui;
...
import com.customCamera.internal.ui.preview.PreviewActivity;
import com.customCamera.internal.ui.view.CameraControlPanel;
import com.customCamera.internal.ui.view.CameraSwitchView;
import com.customCamera.internal.ui.view.FlashSwitchView;
import com.customCamera.internal.ui.view.MediaActionSwitchView;
import com.customCamera.internal.ui.view.RecordButton;
import com.customCamera.internal.utils.MediaConstant;
import com.customCamera.internal.utils.Size;
import com.customCamera.internal.utils.Utils;
...
public abstract class BaseCameraActivity<CameraId> extends CustomCameraActivity<CameraId>
        implements
    ...
    public void onItemClick(Uri filePath) {
        ...
        intent.putExtra(MediaConstant.MEDIA_RESULT,new CameraOutputModel(mimeType, filePath.getPath()));
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_PREVIEW_CODE) {
                if (PreviewActivity.isResultConfirm(data)) {
                    ...
                    Intent intent=new Intent();
                    intent.putExtra(MediaConstant.MEDIA_RESULT,new CameraOutputModel(mimeType, path));
                    setResult(RESULT_OK,intent);
