package com.customCamera.internal.configuration;
...
public final class CameraConfiguration {
    ...
    public interface Arguments {
        String MEDIA_ACTION = "com.customCamera.media_action";
        String MEDIA_QUALITY = "com.customCamera.camera_media_quality";
        String VIDEO_DURATION = "com.customCamera.video_duration";
        String MINIMUM_VIDEO_DURATION = "com.customCamera.minimum.video_duration";
        String VIDEO_FILE_SIZE = "com.customCamera.camera_video_file_size";
        String FILE_PATH = "com.customCamera.camera_video_file_path";
        String FLASH_MODE = "com.customCamera.camera_flash_mode";
        String SHOW_PICKER = "com.customCamera.show_picker";
        String PICKER_TYPE = "com.customCamera.picker_type";
        String ENABLE_CROP = "com.customCamera.enable_crop";
        String AUTO_RECORD = "com.customCamera.auto_record";
    }
